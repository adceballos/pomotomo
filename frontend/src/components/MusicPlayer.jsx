      ...
      <div className="fixed bottom-0 left-0 w-full bg-black/90 text-white px-6 py-3 flex flex-col shadow-md z-50">
        ...
        <div className="flex justify-between items-center w-full">
            ...
            <div className="flex flex-col w-1/3 min-w-0">
                <span className="text-sm font-semibold truncate">{tracks[currentTrack].name}</span>
                <span className="text-sm text-gray-300 truncate">{tracks[currentTrack].artist}</span>
            </div>

            {/* Center: Playback Controls */}
            <div className="flex gap-4 items-center justify-center w-1/3">
